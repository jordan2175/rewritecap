...
This tool is designed for editing timestamps, layer2 and layer3 addresses, and ARP packets in standard PCAP files. PCAP-ng files are not currently supported. This tool will accommodate 802.1Q tagged frames and Q-in-Q double tagged frames. The timestamp changes allow you to rebase the PCAP file to a new date without changing the actual time of day or the inter-frame gaps.  
